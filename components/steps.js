export default function Steps() {
  return (
    <div className="steps">
      <div className="step u-text-center">
        <div className="step__img-box u-margin-bottom-32">
          <div className="step__img">
            ...
            <div className="step__boxes">
              <div className="step__box step__box--gray"></div>
              <div className="step__box step__box--main"></div>
            </div>
          </div>
        </div>
        <h4 className="heading-four u-margin-bottom-16">1. Start your free trial</h4>
      ...
      <div className="step u-text-center">
        <div className="step__img-box u-margin-bottom-32">
          <div className="step__img step__img--grid">
            <img
        ...
        <h4 className="heading-four u-margin-bottom-16">2. Connect your product</h4>
        <p className="step__paragraph">
          {" "}
      ...
      <div className="step u-text-center">
        ...
        <h4 className="heading-four u-margin-bottom-16">3. Get data right in hand</h4>
        <p className="step__paragraph">
          {" "}
